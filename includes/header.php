...
<div class="top-header" style="background:gray">
    <div class="container">
        ...
        <li class="sub"><a href="pending.php">Pending</a></li>
        <li class="sub"><a href="confirmed.php">Confirmed</a></li>
        <li class="sub"><a href="issuetickets.php">Issues</a></li>
    </ul>
...
<div class="top-header">
    <div class="container">
        ...
        <ul class="top-header-right">
            <li class="wel">Call: +919876543210</li>
    ...
    <nav class="navbar navbar-expand-lg navbar-slide-in">
        <div class="container" >
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php"><span style="color: #000;">Home</span></a>
                    </li>
                    <li class="nav-item">

...
$sql="update TblTourPackages set PackageName=:pname,PackageType=:ptype,days=:pdays,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails ,PackageInfo=:pinfo where PackageId=:pid";
$query = $dbh->prepare($sql);
$query->bindParam(':pname',$pname,PDO::PARAM_STR);
$query->bindParam(':ptype',$ptype,PDO::PARAM_STR);
$query->bindParam(':pdays',$ptype,PDO::PARAM_STR);
...
{	?>
                            ...
                            <form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">Package days</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="packagedays" id="packagedays"
                                        placeholder="No.of Days+
                                        *"
                                            value="<?php echo htmlentities($result->days);?>" required>
                                    </div>
                                </div>
